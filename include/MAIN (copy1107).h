...
#define NUM_OF_CANABLE 6 // 8 ////////////////
#define NUM_OF_MOTOR 2   //
// #define SERIAL 0
// #define BLUETOOTH 1
#define JOINT_NUM 7 // 16

// for mission
#define L1 0.35
#define L2 0.38
volatile bool global_planar_flag = false;
volatile bool planar_flag = false;
...
private:
    ...
    rclcpp::Subscription<std_msgs::msg::Float32MultiArray>::SharedPtr yolo_sub;
    ...
    // New variables to replace undeclared ones
    float x_pixel = 0.0f;
    float y_pixel = 0.0f;
    float z_depth = 0.0f;
    float th_elbow = 0.0f;
    float th_shoulder = 0.0f;
    ...
    void yolo_callback(const std_msgs::msg::Float32MultiArray::SharedPtr msg);
