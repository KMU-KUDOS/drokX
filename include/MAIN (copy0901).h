...
#define NUM_OF_MOTOR 2 // 16
#define SERIAL 0
#define BLUETOOTH 1
#define JOINT_NUM 8 //16
...
private:
    ...
    int16_t speed = 0;
    int16_t pulse = 0;
    float pulse_to_degree = 0.00001526 * 40.; /// 1:9 (360) 1:36 1:6
    float degree = 0.;
    float previous_degree_f[NUM_OF_CANABLE][NUM_OF_MOTOR];
     float previous_degree_b[NUM_OF_CANABLE][NUM_OF_MOTOR];
    float output_degree_f= 0.;
    float output_degree_b= 0.;
    float Kp_HR, Kp_HP, Kp_KN;
    float Kd_HR, Kd_HP, Kd_KN;
    float Kp_FR, Kp_FL, Kp_BR, Kp_BL;
    float Kd_FR, Kd_FL, Kd_BR, Kd_BL;
    int angle_switch_f[NUM_OF_CANABLE][NUM_OF_MOTOR];
    int angle_switch_b[NUM_OF_CANABLE][NUM_OF_MOTOR];
    int flag_f[NUM_OF_CANABLE][NUM_OF_MOTOR];
    int flag_b[NUM_OF_CANABLE][NUM_OF_MOTOR];
    int tau[NUM_OF_CANABLE][NUM_OF_MOTOR];
    float flipper_[4]={0.,0.,0.,0.};
    int cansock[NUM_OF_CANABLE];
    int command;
    int err_count = 0;
