...
private:
    ...
    float Kp_X6, Kp_w1, Kp_w2, Kp_w3, Kp_gr;
    float Kd_X6, Kd_w1, Kd_w2, Kd_w3, Kd_gr;
    ...
    struct can_frame frame[NUM_OF_CANABLE]; // NUM_OF_CANABLE <- 4
    Motor_state_t motor_state[NUM_OF_CANABLE];
    Motor_state_t motor_states[NUM_OF_CANABLE];
