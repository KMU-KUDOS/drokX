...
#define NUM_OF_CANABLE 3
#define NUM_OF_MOTOR 3 // 16
#define SERIAL 0
#define BLUETOOTH 1
...
volatile bool can4_thread_exit = false;
volatile bool can5_thread_exit = false;
volatile bool can6_thread_exit = false;
...
private:
    ...
    pthread_t can4_thread;
    pthread_t can5_thread;
    pthread_t can6_thread;
    std::mutex _mtx;
    RMD_COMMAND Rmd;
